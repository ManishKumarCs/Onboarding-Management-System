...
import { Building2, Mail, Lock, User, Briefcase, Building, Eye, EyeOff, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        {token && (
            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-green-700 text-sm text-center">You've been invited to join OMS!</p>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">
                ...
                <Link to="/login" className="font-medium text-yellow-500 hover:text-blue-500">
                  Sign in
                </Link>
              </span>
            </div>
        ...
        <div className="max-w-lg text-center">
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Welcome to <br/> Onboarding Management System (OMS)
            </h3>
            <p className="text-gray-600 mb-6">
              Join thousands of professionals who trust our platform for seamless onboarding and team collaboration.
            </p>
